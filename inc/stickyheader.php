<header id="scroll-header-sticky" class="nav-up">
  <div id="page-head-sticky" class="page-head">
    ...
    <div id="top-row-sticky" class="top-row">
      ...
      <div id= "menu-phone-sticky" class="menu-phone">
        ...
        <div id="contact-link-sticky" class=" contact-link header-btn mp-item">
          <a href="#"
          id="link-button-sticky"><i class="link-button far fa-paper-plane"></i>Contact</a>
        </div>
        <div id="search-sm-sticky" class="search-sm mp-item">
            <input placeholder="Search...">
            <div class="search-icon-container">
              <button id="search-button-sticky" class="search-button" type=submit><i class="fas fa-search"></i></button>
            </div>
        </div>
        <div  id="phone-icon-container-sticky" class="phone-icon-container hidden">
          <a href="tel:01603704020" title="Call 01603704020" target="_blank"><img src="images/telephone.png" alt="phone icon image" id="phone-icon-sticky" class="phone-icon" ></a>
        </div>

        <div id="menu-button-container-sticky" class="menu-button-container" onclick="toggleNav()">
          <button id="hamburger-sticky" class="menu-button-container hamburger hamburger--spin" type="button">
      ...
      <div id="search-bar-container" class="search-bar-container hidden">
        <input placeholder="Search..." id="search-input-sticky" class=" search-input hidden">
  ...
  <div id="navbar-sticky" class="navbar-class nav sticker">
